...
public enum RequestType{
	JOIN_GAME, LEAVE_GAME, CHANGE_GAME_PIECE, ROLL_DICE, SKIP_TURN, BUY_DEED, SELL_DEED, BUY_HOUSE, SELL_HOUSE, BUY_HOTEL, SELL_HOTEL, RAISE_MORTGAGE, REDEEM_MORTGAGE, TRADE_DEED, BID_AT_AUCTION, CHEAT, SETUP_GAMESTATE;
